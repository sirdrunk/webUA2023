...
<head>
	...
	<title>Crear Cuenta - Ultima Alianza (UA)</title>
	...
	<?php include_once("analytics.php") ?>
 	...
 	<main id="main">
		...
		<section class="inner-page">
			<div class="container">
				<div id="crear_cuenta" class="row">
					<div class="col">
						<p><img src="assets/img/crear_cuenta.jpeg" class="img-fluid" /></p>
					</div>
					<div class="col d-flex justify-content-center">
						<div class="d-flex flex-column align-items-center" style="max-width: 700px;">
							<h3 class="mb-3 mt-45 text-center">Crear Cuenta</h3>
							<?php include("C://UA//Servidor//Sphere//Web//cuenta//crear_cuenta.php"); ?>
							<p class="mt-4">Para <strong>recuperar la contraseña</strong> de tu cuenta pulsa <strong><a href="clave.html">aquí</a></strong></p>
							<ul class="mt-4">
								<li>El nombre de cuenta no debe exceder de 14 caracteres.</li>
								<li>Tu e-mail es necesario si quieres recuperar tu contraseña a través del formulario de recuperación de cuentas.</li>
								<li>Si utilizas espacios en blanco para el login, estos serán eliminados automácamente.</li>
								<li>No se admiten los siguientes caracteres: !, ], ?, y \.</li>
								<li>Tu dirección IP y todo lo que envies a través de este formulario quedará grabado por motivos de seguridad.</li>
							</ul>
						</div>
					</div>
				</div>
